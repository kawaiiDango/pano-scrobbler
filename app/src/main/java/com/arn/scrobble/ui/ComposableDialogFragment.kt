 ...
 */
class ComposableDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        return ComposeView(requireContext()).apply {
            ...
            setContent {
                CompositionLocalProvider(LocalFragment provides this@ComposableDialogFragment) {
    ...
    companion object {
        ...
        /**
         * Creates a new [ComposableDialogFragment] instance that will wrap the Composable method loaded
         ...
         */
        @JvmStatic
        fun ComposableFragment(fullyQualifiedName: String): ComposableDialogFragment {
            return ComposableDialogFragment().apply {
