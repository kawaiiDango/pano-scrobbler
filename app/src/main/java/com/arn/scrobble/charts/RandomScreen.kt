...
private fun RandomTypeSelector(
    ...
    fun getTextForType(type: Int) = when (type) {
        Stuff.TYPE_ARTISTS -> stringResource(id = R.string.artist)
        Stuff.TYPE_ALBUMS -> stringResource(id = R.string.album)
        Stuff.TYPE_TRACKS -> stringResource(id = R.string.track)
        Stuff.TYPE_LOVES -> stringResource(id = R.string.loved)
        else -> error("Unknown type $type")
    }
