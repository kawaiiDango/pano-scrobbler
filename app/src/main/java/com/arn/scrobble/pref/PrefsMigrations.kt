...
class MainPrefsMigration5 : DataMigration<MainPrefs> {
    ...
    override suspend fun migrate(currentData: MainPrefs): MainPrefs {
        ...
        val sharedPreferences = PlatformStuff.application.getHarmonySharedPreferences("main")
        ...
        val seenPackages = sharedPreferences.getStringSet("apps_seen", emptySet()) ?: emptySet()
        ...
        val notiPersistent =
            sharedPreferences.getBoolean("noti_persistent", Stuff.forcePersistentNoti)
        ...
        val cookiesPrefs = PlatformStuff.application.getHarmonySharedPreferences("LastFmCookies")
...
class WidgetPrefsMigration1 : DataMigration<WidgetPrefs> {
    private val sharedPreferences by lazy { PlatformStuff.application.getHarmonySharedPreferences("widget") }
