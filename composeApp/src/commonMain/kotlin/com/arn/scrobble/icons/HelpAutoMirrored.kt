...
val Icons.HelpAutoMirrored: ImageVector
  get() {
    if (_HelpAutoMirrored != null) {
      return _HelpAutoMirrored!!
    }
    _HelpAutoMirrored =
      ImageVector.Builder(
          name = "HelpAutoMirrored",
          defaultWidth = 24.dp,
          defaultHeight = 24.dp,
          viewportWidth = 24f,
          viewportHeight = 24f,
...
private var _HelpAutoMirrored: ImageVector? = null
