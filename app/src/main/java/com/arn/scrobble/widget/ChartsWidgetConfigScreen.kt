...
fun ChartsWidgetConfigScreen(
    ...
    prefs?.let { prefs ->
        ...
        val allPeriods = remember {
            val wtp = WidgetTimePeriods(context)
        ...
        Column(
            ...
            Surface(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(id = R.string.appwidget_period),
                    ...
                    Text(
                        text = stringResource(id = R.string.appwidget_alpha),
                        style = MaterialTheme.typography.titleMedium
                    )
                    Slider(
                        value = bgAlpha,
                    ...
                    LabeledSwitch(
                        text = stringResource(id = R.string.appwidget_shadow),
                        checked = shadow,
