...
val Icons.VolumeOffAutoMirrored: ImageVector
  get() {
    if (_VolumeOffAutoMirrored != null) {
      return _VolumeOffAutoMirrored!!
    }
    _VolumeOffAutoMirrored =
      ImageVector.Builder(
          name = "VolumeOffAutoMirrored",
          defaultWidth = 24.dp,
          defaultHeight = 24.dp,
          viewportWidth = 24f,
          viewportHeight = 24f,
...
private var _VolumeOffAutoMirrored: ImageVector? = null
